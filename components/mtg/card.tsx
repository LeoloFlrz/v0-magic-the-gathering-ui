  ...
  const cardElement = (
    <div
      className={cn(
        ...
        canPlay && !faceDown && !card.isTapped && "ring-2 ring-green-500 ring-offset-1 shadow-green-500/50 shadow-lg",
        isAttacking && "ring-2 ring-red-500 ring-offset-1 shadow-red-500/50 shadow-lg",
        isBlocking && "ring-2 ring-blue-500 ring-offset-1 shadow-blue-500/50 shadow-lg",
        isSelectedForCombat && "ring-2 ring-yellow-400 ring-offset-1 shadow-yellow-400/50 shadow-lg",
